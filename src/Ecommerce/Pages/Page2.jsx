    ...
    <>
      <div className="h-auto bg-dark-gray ">
        <div className="object-contain flex flex-wrap gap-2 justify-center items-center py-9 px-8 ">
          <img className="h-44" src={img1} />
          <img className="h-44" src={img2} />
          <img className="h-44" src={img3} />
          <img className="h-44" src={img4} />
          <img className="h-44" src={img5} />
          <img className="h-44" src={img6} />
          <img className="h-44" src={img7} />
          <img className="h-44" src={img8} />
          <img className="h-44" src={img9} />
          <img className="h-44" src={img10} />
        </div>
        {/*----------------discount img------------- */}
